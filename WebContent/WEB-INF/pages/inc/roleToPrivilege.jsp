...
<c:set var="moduleKey" value="roleToPrivilege"/> 
<so:load-module-phrase module="roleToPrivilege" />
<so:lookup category="roleToPrivilege.category;roleToPrivilege.status;" />
