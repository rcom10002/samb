...
<c:set var="moduleKey" value="role"/> 
<so:load-module-phrase module="role" />
<so:lookup category="role.roleName;role.roleStatus;" />
						...
						<form class="form-inline">
							<div class="form-group">
								<div class="input-group">
								    ...
								    <input type="text" class="form-control" id="input-addView-user" ng-model="page.addView.model._entryModel['_privilegeId']" readonly />
							        <span class="input-group-btn"><button class="btn btn-default" type="button" ng-click="page.privilegeLinkedHandler('addView')"><span class="glyphicon glyphicon-link"></span></button></span>
								    <input type="hidden" ng-model="page.addView.model._entryModel['privilegeId']" />
								</div>
