...
<c:set var="moduleKey" value="requirement"/> 
<so:load-module-phrase module="${moduleKey}" />
<so:lookup category="requirement.location;requirement.status;" />
<div role="tabpanel" class="tab-pane active" id="listView" ng-if="page.listView.visible">
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading container-fluid">
			...
			<a class="btn btn-default" href="{{page.exceluri('exportRequirement')}}"><span class="glyphicon glyphicon-export" aria-hidden="true"></span></a>
