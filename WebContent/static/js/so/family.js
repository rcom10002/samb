...
app.controller(moduleName + "-controller", function ($scope, $http) {
	...
	{
		"category"    : { "name": "category"    , "check": page._validation["category"    ], "label": "family.category"    , "type": "select", "select-source": "family.category" },
		"name"        : { "name": "name"        , "check": page._validation["name"        ], "label": "family.name"                             },
		"applicant"   : { "name": "applicant"   , "check": page._validation["applicant"   ], "label": "family.applicant"                        },
		"status"      : { "name": "status"      , "check": page._validation["status"      ], "label": "family.status"      , "type": "select", "select-source": "family.status" },
		"amount"      : { "name": "amount"      , "check": page._validation["amount"      ], "label": "family.amount"      , "type": "number"   },
		"detail"      : { "name": "detail"      , "check": page._validation["detail"      ], "label": "family.detail"      , "type": "textarea" },
		"memo"        : { "name": "memo"        , "check": page._validation["memo"        ], "label": "family.memo"        , "type": "textarea" },
		"mailEvidence": { "name": "mailEvidence", "check": page._validation["mailEvidence"], "label": "family.mailEvidence", "type": "files", "file-handler": fileHandler },
	...
	var columnDefs = 
		[
            {"field": "category"    , "displayName": "family.category"    }, 
            {"field": "name"        , "displayName": "family.name"        }, 
            {"field": "applicant"   , "displayName": "family.applicant"   }, 
            {"field": "status"      , "displayName": "family.status"      }, 
            {"field": "amount"      , "displayName": "family.amount"      }, 
            {"field": "detail"      , "displayName": "family.detail"      }, 
            {"field": "memo"        , "displayName": "family.memo"        }, 
