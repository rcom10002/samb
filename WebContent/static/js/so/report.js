...
app.controller(moduleName + "-controller", function ($scope, $http) {
	...
	{
		"category"    : { "name": "category"    , "check": page._validation["category"    ], "label": "report.category"    , "type": "select", "select-source": "report.category" },
		"name"        : { "name": "name"        , "check": page._validation["name"        ], "label": "report.name"                             },
		"applicant"   : { "name": "applicant"   , "check": page._validation["applicant"   ], "label": "report.applicant"                        },
		"status"      : { "name": "status"      , "check": page._validation["status"      ], "label": "report.status"      , "type": "select", "select-source": "report.status" },
		"amount"      : { "name": "amount"      , "check": page._validation["amount"      ], "label": "report.amount"      , "type": "number"   },
		"detail"      : { "name": "detail"      , "check": page._validation["detail"      ], "label": "report.detail"      , "type": "textarea" },
		"memo"        : { "name": "memo"        , "check": page._validation["memo"        ], "label": "report.memo"        , "type": "textarea" },
		"mailEvidence": { "name": "mailEvidence", "check": page._validation["mailEvidence"], "label": "report.mailEvidence", "type": "files", "file-handler": fileHandler },
	...
	var columnDefs = 
		[
            ...
            {"field": "applicant"   , "displayName": "report.applicant"   }, 
            {"field": "status"      , "displayName": "report.status"      }, 
            {"field": "amount"      , "displayName": "report.amount"      }, 
            {"field": "detail"      , "displayName": "report.detail"      }, 
            {"field": "memo"        , "displayName": "report.memo"        }, 
